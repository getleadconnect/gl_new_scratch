...
var KTLoginGeneral = function() {
    ...
    function glScrtachView(offerListing) {
        ...
        var status = offerListing.winning_status;

        if (status == 1) {
            selectBG = baseUrl+'/'+offerListing.gift_image;
            promoCode =   '<span style="color:#ffa01d">Congratulations '+offerListing.customer_name+'!!</span><br> <span style="color:#000;font-size:12px">You have won:</span> ' + offerListing.description;
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        if(data.status == true)
                        {
                            ...
                            $.alert({
                                title: 'Warning', type: 'red', content: data.msg,
                            });
                        }
                        hideSpinner($button,'');
                    }
