...
<div class="space-y-6">
    ...
    <!-- Two-column Row: 70% filter / 30% future -->
    <div id="gl-split-panel" style="display:flex;gap:20px;">

        <!-- Left Column (70%) — Filter Card -->
        <div id="gl-left-col" style="width:70%;flex-shrink:0;">
        ...
        <!-- Right Column (30%) — Future Use Card -->
        <div id="gl-right-col" style="width:30%;flex-shrink:0;">
            <div class="bg-white shadow-sm rounded-lg h-full" style="border: 1px solid #e4e4e4;">
                <div class="px-5 py-3 flex items-center gap-2" style="border-bottom:1px solid #e4e4e4;">
                    <svg class="w-5 h-5 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    <span class="text-sm font-semibold text-gray-700">Add New Gifts</span>
                </div>
                <div class="p-4">
                ...
                <div class="flex flex-wrap items-end gap-3">
                        ...
                        <!-- Buttons -->
                        <div class="flex items-end gap-2">
                            <a href="#" id="btn-add-gift"
                                class="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium transition-colors"
                                style="background:#9ca3af;color:#fff;pointer-events:none;opacity:0.6;cursor:not-allowed;">
                                <svg class="w-5 h-5 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                                Add Gift
    ...
    <div class="bg-white shadow-sm rounded-lg" style="border: 1px solid #e4e4e4;">
        <div class="px-5 py-3 flex items-center gap-2" style="border-bottom:1px solid #e4e4e4;">
            ...
            <span class="text-sm font-semibold text-gray-700">Gifts List</span>
        </div>
        <div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow-lg w-full mx-4" style="max-width:480px;">
        ...
        <div class="px-6 py-5 space-y-4">
            ...
            <div>
                ...
                <p id="edit_desc_error" class="text-sm mt-1" style="color:#dc2626;display:none;"></p>
            </div>
...
{
    var cid=$(this).val();
    var $btn = $("#btn-add-gift");
    if(cid!="")
    {
        var link="{{url('/user/campaigns')}}/"+cid+"/gifts";
        $btn.attr('href',link);
        $btn.css({
            'background':'#18181b',
            'pointer-events':'auto',
...
@media (max-width: 640px) {
    #gl-split-panel { flex-direction: column; }
    #gl-left-col { width: 100% !important; }
    #gl-right-col { width: 100% !important; }
}
</style>
