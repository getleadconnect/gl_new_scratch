    ...
    <div class="bg-white rounded-lg border border-border shadow-sm p-5">
        <div class="flex items-start justify-between">
            ...
            <div class="text-right">
                <p class="text-sm font-medium text-muted-foreground">Available Scratch Credits:</p>
            ...
            <div class="bg-white rounded-lg border border-border shadow-sm p-5">
                ...
                <form id="addGiftForm" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Gift Count -->
                        <div>
                            <label class="block text-sm font-medium text-muted-foreground mb-1">Gift Count</label>
