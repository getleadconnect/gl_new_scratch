...
<div class="space-y-6">
    ...
    <!-- Page Header -->
    <div id="camp-page-header" class="flex items-center justify-between">
        <div>
    ...
    <div class="bg-white shadow-sm rounded-lg p-4" style="border: 1px solid #e4e4e4;">
        <div id="camp-filter-fields" class="flex flex-wrap items-end gap-3">
            <!-- Status -->
            <div>
    ...
    <!-- DataTable Card -->
    <div id="camp-datatable-wrap" class="bg-white shadow-sm rounded-lg" style="border: 1px solid #e4e4e4;">
        <div class="p-6">
