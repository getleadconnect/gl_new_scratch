    ...
    <div class="bg-white rounded-lg border border-border shadow-sm p-5">
        <div class="flex items-start justify-between">
            ...
            <div class="text-right">
                ...
                <p class="text-2xl font-bold text-red-500">{{ $scratchCount }}</p>
            </div>
        </div>
    </div>
        ...
        <form id="addGiftForm" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-12 gap-4 items-end">
                ...
                <div class="col-span-12 sm:col-span-2">
                    <label class="block text-xs font-medium text-muted-foreground mb-1">Gift_Count</label>
                    <input type="number" name="gift_count" id="gift_count" min="1"
                ...
                <!-- Image Preview -->
                <div class="col-span-12 sm:col-span-1 flex items-end justify-center">
...
$(document).ready(function () {
    ...
    var table = $('#gifts-table').DataTable({
        ...
        columns: [
            ...
            { data: 'gift_count',  name: 'gift_count' },
            { data: 'stage',       name: 'stage',       orderable: false },
            { data: 'description', name: 'description', orderable: false },
            { data: 'balance_count', name: 'balance_count' },
            { data: 'win_loss',    name: 'win_loss',    orderable: false },
