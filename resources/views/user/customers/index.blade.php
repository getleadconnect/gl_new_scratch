...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-muted-foreground">All customers who participated in your campaigns</p>
        </div>
    </div>
        ...
        <div class="p-4">
            <div class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select id="filter-branch" class="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary" style="min-width:180px;">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select id="filter-win" class="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary" style="min-width:180px;">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select id="filter-redeem" class="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary" style="min-width:180px;">
                        <option value="">All Status</option>
    ...
    <div class="bg-white shadow-sm rounded-lg" style="border: 1px solid #e4e4e4;">
        <div class="p-6">
            <table id="customers-table" class="data-table w-full" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl No</th>
                        <th>Name</th>
...
$(document).ready(function () {
    ...
    $('#btn-export').on('click', function () {
        ...
        window.location.href = "{{ route('user.customers.export') }}?" + params.toString();
    });
