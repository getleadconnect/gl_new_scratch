...
<div class="space-y-6">
    ...
    <!-- Page Header -->
    <div class="flex items-center justify-between" id="sl-page-header">
        <div>
        ...
        <div class="flex items-center gap-2" id="sl-header-btns">
            ...
            <div style="border:1px solid #c4c4c4;background:#f7e6e6;padding:7px;border-radius:10px;">
    ...
    <div class="bg-white shadow-sm rounded-lg" style="border: 1px solid #e4e4e4;">
        ...
        <div class="p-4">
            <div class="flex flex-wrap items-end gap-3" id="sl-filter-fields">
    ...
    <div class="bg-white shadow-sm rounded-lg" style="border: 1px solid #e4e4e4;">
        ...
        <div class="p-4" id="sl-datatable-wrap">
            <table id="scratch-links-table" class="data-table w-full" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>Branch<br><span style="font-size:10px;font-weight:400;color:#6b7280;">(Required)</span></th>
                        <th>Click Count</th>
                        <th>Status</th>
                        <th>Action</th>
                    </tr>
...
<div id="addLinkModal" class="hidden fixed inset-0 z-50 flex items-center justify-center" style="background-color:#c9c4c442;">
    <div class="bg-white rounded-lg shadow-lg w-full mx-4" style="max-width:480px;">
        ...
        <div class="px-6 py-5 space-y-4">
            <!-- Info bullets -->
            <ul style="padding:0px 10px 10px 15px;list-style:disc;margin:0;">
                <li class="text-sm" style="color:#2563eb;">To create single scratch link for all customers</li>
            </ul>
    ...
    <div class="bg-white rounded-lg shadow-lg w-full mx-4" style="max-width:480px;">
        ...
        <div class="px-6  space-y-4">
            ...
            <ul style="padding:18px 10px;list-style:disc;margin:0;">
                <li class="text-sm" style="color:#2563eb;">In this form, create one-time scratch link for each product.
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    Links Count
                    <span style="font-size:11px;color:#6b7280;">(Max : <span style="font-weight:900;font-size:12px;">1000</span> links only)</span>
                    <span style="color:#dc2626;">*</span>
                </label>
...
@media (max-width: 640px) {
    /* Page header — stack title above buttons */
    #sl-page-header {
    ...
    #sl-header-btns > div > button {
        width: 100%;
        justify-content: center;
    }

    /* Filter fields — full width, stacked */
    #sl-filter-fields {
        flex-direction: column;
        align-items: stretch;
    }
    #sl-filter-fields > div {
        width: 100%;
    }
    #sl-filter-fields select {
        min-width: unset !important;
        width: 100%;
    }
    #sl-filter-fields .flex.items-end.gap-2 {
        flex-direction: column;
    }
    #sl-filter-fields .flex.items-end.gap-2 button {
        width: 100%;
        justify-content: center;
    }
