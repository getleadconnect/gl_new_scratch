 ...
 <!-- Page Header -->
    <div id="users-page-header" class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-muted-foreground">Manage all registered child users</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <div>
                    ...
                    <input type="date" name="subscription_end_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                     value="{{\Carbon\Carbon::now()->addMonths(12)->format('Y-m-d')}}" readonly>
                </div>
                <div>
                    <label class="block text-xs font-small text-blue-600 mb-1 mt-0">1 year subscription</label>
                </div>
